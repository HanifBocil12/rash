...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      {/* 🔸 Foreground content — NO PADDING, FULL EDGE-TO-EDGE */}
      <div className="relative z-10 min-h-screen bg-gray-500/30 backdrop-blur-md w-full flex justify-center items-center">
