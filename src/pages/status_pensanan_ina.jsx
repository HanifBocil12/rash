...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      {/* 🔸 Blur layer di atas animasi */}
      <div className="fixed inset-0 z-10 backdrop-blur-[60px] bg-white/10" />

      {/* 🔸 Foreground content */}
      <div className="relative z-20 min-h-screen py-8 px-4 flex flex-col items-center">
        <div className="max-w-2xl w-full bg-white/70 backdrop-blur-md rounded-2xl shadow-xl p-6 md:p-8 border border-white/40">
