...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      {/* 🔸 Foreground content */}
      <div className="relative z-10 min-h-screen bg-gray-500/30 backdrop-blur-md py-8 px-4relative z-10 w-full min-h-screen bg-gray-500/30 backdrop-blur-md m-0 ml-4 p-0 pl-4">
