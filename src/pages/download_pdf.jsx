...
export default function DownloadPDFPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      {/* Foreground container disamakan dengan Home */}
      <div className="relative z-10 min-h-screen bg-white/40 py-6 px-3 flex items-center sm:block">
        <div className="w-full max-w-4xl mx-auto mt-10 bg-white/90 rounded-xl shadow-md p-6 md:p-8 backdrop-blur-md">

          <h1 className="text-xl md:text-3xl font-bold text-gray-800 mb-2">📄 PDF Selesai</h1>
          ...
          <div className="mt-8 pt-6 border-t text-center text-gray-500 text-xs md:text-sm">
