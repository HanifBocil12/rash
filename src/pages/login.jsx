      ...
      <div className="
            ...
            >
              ...
              <div className="flex-1 w-full flex flex-col items-center justify-center">
                <div className="w-full max-w-sm sm:max-w-md lg:max-w-lg space-y-6 sm:space-y-8 p-[5vw] sm:p-8">
                  <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-gray-800 text-center leading-tight">
                    <div>solusi hanif</div>
                    <div className="text-orange-600">Revolution</div>
                    <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl">Ai</div>
                  </h1>

                  <div className="bg-white bg-opacity-80 backdrop-blur-sm p-[4vw] sm:p-6 rounded-2xl shadow-xl border border-orange-100">
                    <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-800 mb-4 sm:mb-6">Sign In</h2>
                    ...
                    <form className="space-y-4" onSubmit={handleLogin}>
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 sm:py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 transition-colors"
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 sm:py-2.5 pr-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500"
                          placeholder="••••••••"
                          required
                        />
                        <button
