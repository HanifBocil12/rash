      ...
      <div className="
            ...
            >
              ...
              <div className="flex-1 w-full flex flex-col items-center justify-center">
                <div className="w-full max-w-[90vw] sm:max-w-sm md:max-w-md lg:max-w-lg space-y-6 sm:space-y-8 p-4 sm:p-6 md:p-8">
                  <h1 className="text-[6vw] sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 text-center leading-tight">
                    <div>solusi hanif</div>
                    <div className="text-orange-600">Revolution</div>
                    <div className="text-[4vw] sm:text-2xl md:text-3xl lg:text-4xl">Ai</div>
                  </h1>

                  <div className="bg-white bg-opacity-80 backdrop-blur-sm p-[5vw] sm:p-6 md:p-8 rounded-2xl shadow-xl border border-orange-100">
                    <h2 className="text-[5vw] sm:text-xl md:text-2xl font-bold text-gray-800 mb-4 sm:mb-6">Sign In</h2>

                    {errorMsg && (
                      <p className="text-sm sm:text-base mb-3 text-center text-red-600">{errorMsg}</p>
                    )}
