    ...
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-orange-50 via-orange-100 to-red-50">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6">
        <header className="absolute top-6 left-6">
          <h1 className="text-xl font-bold text-orange-600">LiquidFlow</h1>
        </header>

        <button className="absolute top-6 right-6 bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg text-sm">
          Get Started
        </button>
        ...
        <div className="max-w-md w-full space-y-6">
          ...
          <div className="bg-white bg-opacity-80 backdrop-blur-sm p-6 rounded-2xl shadow-xl max-w-[400px] mx-auto">
            <h2 className="text-xl font-bold text-gray-800 mb-4">Sign In</h2>

            {errorMsg && (
              <p className="text-red-600 text-xs mb-3 text-center">{errorMsg}</p>
            )}
            ...
            <form className="space-y-3" onSubmit={handleLogin}>
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 transition-colors text-sm"
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-2 top-[calc(50%+0.5rem)] -translate-y-1/2 text-gray-500"
                >
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <input id="remember-me" type="checkbox" className="h-3 w-3 text-orange-600" />
                  <label htmlFor="remember-me" className="ml-1 text-xs text-gray-700">
                    Remember me
                  </label>
                </div>
                <a className="text-xs text-orange-600 hover:text-orange-700">Forgot password?</a>
              </div>

              <button
                type="submit"
                disabled={loading}
                className="w-full bg-orange-500 hover:bg-orange-600 text-white font-semibold py-2 px-4 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-md text-sm"
              >
          ...
          <div className="flex flex-col sm:flex-row gap-2 mt-6">
            <button className="flex-1 bg-orange-500 hover:bg-orange-600 text-white font-semibold py-2 px-4 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-md text-sm">
              Start Free Trial
            </button>
            <button className="flex-1 border-2 border-orange-500 text-orange-600 hover:bg-orange-50 py-2 px-4 rounded-lg transition-all duration-300 transform hover:scale-105 text-sm">
              Watch Demo
            </button>
          </div>
        </div>
