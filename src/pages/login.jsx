      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6">
        ...
        <div className="w-full max-w-[400px] space-y-4">
          ...
          <div className="bg-white bg-opacity-80 backdrop-blur-sm p-5 rounded-2xl shadow-xl">
            ...
            <form className="space-y-2" onSubmit={handleLogin}>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-orange-500 hover:bg-orange-600 text-white font-semibold py-1.5 px-4 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-md text-xs"
              >
          ...
          <div className="flex flex-col sm:flex-row gap-2 mt-4">
            ...
            <button className="flex-1 border-2 border-orange-500 text-orange-600 hover:bg-orange-50 py-1.5 px-4 rounded-lg transition-all duration-300 transform hover:scale-105 text-xs">
              Watch Demo
            </button>
          </div>
        </div>
