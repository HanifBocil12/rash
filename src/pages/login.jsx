  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-orange-50 via-orange-100 to-red-50">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 sm:px-6">
        ...
        <button className="absolute top-4 right-4 sm:top-6 sm:right-6 bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg text-[0.875vw] sm:text-base">
          Get Started
        </button>
        ...
        <div className="w-full max-w-sm sm:max-w-md space-y-6 sm:space-y-8">
          ...
          <div className="bg-white bg-opacity-80 backdrop-blur-sm p-6 sm:p-8 rounded-2xl shadow-xl border border-orange-100">
            ...
            <form className="space-y-4" onSubmit={handleLogin}>
              <div>
                <label className="block text-[0.875vw] font-medium text-gray-700 mb-1">Email</label>
                <input
                  type="email"
                  value={email}
              ...
              <div className="relative">
                <label className="block text-[0.875vw] font-medium text-gray-700 mb-[0.5vw]">
                  Password
                </label>
                <input
                  ...
                  className="w-full px-[0.75vw] py-[1vw] pr-[2.5vw] border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500"
                  placeholder="••••••••"
                  required
                />
                <button
                  ...
                  className="absolute right-[0.75vw] top-[50%] -translate-y-1/2 text-gray-500"
                >
                  {showPassword ? <EyeOff className="h-[1.25vw] w-[1.25vw]" /> : <Eye className="h-[1.25vw] w-[1.25vw]" />}
                </button>
              </div>
