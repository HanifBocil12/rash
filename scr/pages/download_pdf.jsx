...
export default function App() {
    ...
    if (agentStatus.flag === 'RUN') {
      return (
        <div className="flex items-center space-x-2 text-yellow-700 bg-yellow-50 p-3 rounded-lg">
          ...
          <span>
            <strong>Agent sedang berjalan</strong> (task: {agentStatus.last_task || 'None'})
          </span>
        </div>
      );
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      {/* Include sidebar dari file yang sudah ada */}
      <Sidebar />

      {/* Konten utama */}
      <main className="flex-1 p-4 md:p-6">
        <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-md p-6 md:p-8">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mb-2">📋 PDF Selesai</h1>
